...
game.States.main = function () {
  this.create = function () {
    ...
    shengyu.cameraOffset.setTo(
      game.camera.width - rfuc(150),
      game.camera.height - rfuc(85),
    );
    ...
    chaisan.cameraOffset.setTo(
      game.camera.width - rfuc(150),
      game.camera.height - rfuc(60),
    );
    this.leftTimeText = game.add.text(0, 0, "00:" + this.leftTime, {
      font: "22px Arial",
      fill: "#93502a",
    });
    this.leftTimeText.scale.setTo(rfuc(1));
    this.leftTimeText.fixedToCamera = true;
    this.leftTimeText.cameraOffset.setTo(
      game.camera.width - rfuc(80),
      game.camera.height - rfuc(88),
    );
    this.chaiisanNum = game.add.text(0, 0, score.toString(), {
      font: "22px Arial",
      fill: "#93502a",
    });
    this.chaiisanNum.scale.setTo(rfuc(1));
    this.chaiisanNum.fixedToCamera = true;
    this.chaiisanNum.cameraOffset.setTo(
      game.camera.width - rfuc(80),
      game.camera.height - rfuc(64),
    );
  };
